...
**Note:** This package uses manual NPM authentication management (like semantic-release) rather than relying on GitHub Actions' setup-node registry configuration. This gives you full control over the authentication process.
